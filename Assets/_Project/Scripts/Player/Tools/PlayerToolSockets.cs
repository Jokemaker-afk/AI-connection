...
public class PlayerToolSockets : MonoBehaviour
{
    ...
    public void EnsureSockets()
    {
        ...
        if (thirdPersonToolSocket == null)
        {
            ...
            Transform modelRoot = visualRoot != null
                ? visualRoot.Find(PlayerVisualBuilder.DirectionalModelName)
                : null;
            Transform modelContent = modelRoot != null ? modelRoot.Find("ModelContent") : null;
            Transform handParent = modelContent != null ? modelContent : visualRoot != null ? visualRoot : playerRoot;
